...
The goal of this project is to showcase backend development skills using Java and Spring Boot in a professional and industry-aligned manner.
...
4. Update `application.properties` if required  
